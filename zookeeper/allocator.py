...
class PartitionAllocator(object):
    ...
    def members_path(self):
        ...
        """
        return "/yhhl/%s/members" % self.group_name
    ...
    def partition_path(self):
        ...
        """
        return "/yhhl/%s/partitions" % self.group_name
    ...
    def handle_connection_change(self, state):
        ...
        """
        #print("handle_connection_change:{}".format(state))
    ...
    def on_group_members_change(self, new_members):
        ...
        #print("on_group_members_change:{}".format(new_members))
